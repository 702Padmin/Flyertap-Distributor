...
Of course, we will also need the ability to take on the job. So there should be a button where users can accept the job. We would like to get notified whenever someone takes on a job.
